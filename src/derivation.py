...
def intention(nodes: Union[list, np.ndarray], context: sparse.csr_matrix) -> np.ndarray:
...
def extension_csc(attributes: Union[list, np.ndarray], context_csc: sparse.csc_matrix) -> np.ndarray:
