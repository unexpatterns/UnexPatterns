...
def attr_unexpectedness(biadjacency: sparse.csr_matrix, attributes: Union[list, np.ndarray], degrees: np.ndarray) \
        -> float:
...
def pattern_unexpectedness(adjacency: sparse.csr_matrix, biadjacency: sparse.csr_matrix, gen_complexities: dict, 
