...
def get_summarized_biadjacency(adjacency: sparse.csr_matrix, biadjacency: sparse.csr_matrix, 
                               patterns: list) -> sparse.csr_matrix:
    """Get summarized biadjacency matrix given an original graph and a list of patterns. Summarized biadjacency 
    contains all links between nodes and attributes that are induced by a summarized graph.
